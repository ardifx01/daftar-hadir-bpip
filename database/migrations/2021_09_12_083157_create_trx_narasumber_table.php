...
class CreateTrxNarasumberTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trx_narasumber', function (Blueprint $table) {
            $table->id();
            $table->string('jenis_peserta', 255); // Internal / Eksternal
            $table->string('tipe_narsum', 255); // PNS / Swasta
    ...
    {
        Schema::dropIfExists('trx_narasumber');
    }
}
